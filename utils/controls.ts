...
export const isCustomEvent = (name: string) => {
  return automaticEventTriggerNames.indexOf(name) !== -1 || gestureEventNames.indexOf(name) !== -1;
};
...
for (let trigger of eventTriggerNames) {
  eventTriggerPropertyControls[`${trigger}Action`] = {
    ...
    optionTitles: ['Not Set', 'Specific State Index', 'Specific State Name', 'Previous State', 'Next State'],
    defaultValue: 'unset',
  ...
  eventTriggerPropertyControls[`${trigger}SpecificIndex`] = {
    ...
    displayStepper: true,
    defaultValue: 0,
    hidden: props => props.isInteractive === false || props[`${trigger}Action`] !== 'specific',
  };
  ...
  eventTriggerPropertyControls[`${trigger}SpecificName`] = {
    ...
    defaultValue: '',
    hidden: props => props.isInteractive === false || props[`${trigger}Action`] !== 'specific-name',
  };
  ...
  if (keyEventTriggerNames.indexOf(trigger) !== -1) {
    eventTriggerPropertyControls[`${trigger}Key`] = {
      ...
      type: ControlType.String,
      defaultValue: '',
      hidden: props => props.isInteractive === false || props[`${trigger}Action`] === 'unset',
    };
  }
